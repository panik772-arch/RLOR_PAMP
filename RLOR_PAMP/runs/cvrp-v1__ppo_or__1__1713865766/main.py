...
def parse_args():
    ...
    parser.add_argument("--problem", type=str, default="cvrp_fleet_tw_env",
    ...
    for update in range(1, num_updates + 1):
        ...
        with torch.no_grad():
            ...
            for t in reversed(range(args.num_steps)):
                ...
                # The advantage is calculated using Generalized Advantage Estimation (GAE).
