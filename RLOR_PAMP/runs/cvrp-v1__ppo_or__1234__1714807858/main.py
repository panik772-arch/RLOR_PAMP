...
def parse_args():
    ...
    parser.add_argument("--total-timesteps", type=int, default=6_000_000, #000_000
        help="total timesteps of the experiments")
    parser.add_argument("--learning-rate", type=float, default=1e-3,
        help="the learning rate of the optimizer")
    parser.add_argument("--weight-decay", type=float, default=0,
        help="the weight decay of the optimizer")
    parser.add_argument("--num-envs", type=int, default=128, #1024
    ...
    parser.add_argument("--update-epochs", type=int, default=1, #orig 2
