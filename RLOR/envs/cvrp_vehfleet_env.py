...
class CVRPFleetEnv(gym.Env):
    ...
    def _go_to(self, destination):
        ...
        if len(true_indices)>0:
            ...
            # here are some inconsistencies. the agent often keep staying in depot  (waiting till all trajectories return DONE ot nr.of steps..),
